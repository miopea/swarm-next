  ...
  render() {
    ...
    return (
      <main className="app-crash-recovery">
        ...
        <p>Reloading this view does not restart your workers. Reconnect to check their current state; a content-free failure marker will be available in dogfood feedback.</p>
