...
export default function TerminalPoolFixture() {
  ...
  const [generations, setGenerations] = useState(Array<number>(8).fill(0));
  ...
  return <main>
    ...
    <button onClick={() => setRetained(terminalWorkspace.rendererRetention.retained)}>Inspect retained renderers</button>
    {retained !== undefined && <p role="status">{retained} retained browser renderers</p>}
