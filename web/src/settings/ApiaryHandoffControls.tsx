  ...
  return (
    <div className="apiary-generated-link" role="group" aria-label="Created Apiary link">
      ...
      <ol className="apiary-generated-link-steps" aria-label="How the personal Hive uses this invitation">
        ...
        <ApiaryExchangeStep number="2" title="Her Hive connects outward" detail="The link opens Settings → Your Hive → Apiary and prefills Connect to Keeper. No inbound access to her computer is needed." />
      ...
      <small className="apiary-generated-link-fallback">If opening the link cannot reach her personal Hive, she can paste the complete link into Settings → Your Hive → Apiary → Join a Keeper&apos;s Apiary.</small>
    </div>
  );
}
