    ...
    <div className="apiary-hive-candidates apiary-link-invitations">
      <div className="apiary-invite-heading">
        <span>
          ...
          <small>Create one private link, then send it to the other operator. Opening it guides her to her personal Hive and prefills Settings → Connections → Your Apiary → Join a Keeper&apos;s Apiary. Her Hive connects outward to this Keeper, so no inbound access to her computer is required.</small>
        </span>
