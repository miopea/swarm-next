...
test("Keeper creates one private invitation link for an outbound member connection", async () => {
  ...
  expect(screen.getByRole("group", { name: "Created Apiary link" })).toHaveTextContent(/paste the complete link into Settings.*Your Hive.*Apiary.*Join a Keeper's Apiary/i);
