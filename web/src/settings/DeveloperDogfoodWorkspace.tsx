...
export default function DeveloperDogfoodWorkspace({ runtime, version, reachable, collection, operatorToken }: {
  ...
  return <section id="settings-dogfood" className="settings-card" aria-labelledby="dogfood-heading">
    ...
    <small>These two phases belong to the same slowest return, not independent maxima or p95 phases. Setup includes opening and fitting the renderer before connection start; connection includes retries and state application. Neither proves screen paint or input ownership. Interrupted phase evidence is unavailable, not zero.</small>
