...
test("shows runtime diagnostics and changes the selected theme", () => {
  ...
  render(<SettingsWorkspace colorTheme="light" liveFeedState="connected" hiveIdentity={{ operator: { id: "operator-1", display_name: "Bea" }, hive: { id: "hive-1", name: "Meadow Hive", operator_id: "operator-1", apiary_id: null } }} health={{ status: "ok", version: "0.1.0" }} runningWorkers={2} retainedSessions={3} onThemeChange={onThemeChange} />);
