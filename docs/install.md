...
```
curl -fsSLO https://github.com/miopea/swarm-next/releases/download/v0.5.0/swarm-0.5.0-linux-x86_64.tar.gz
tar -xzf swarm-0.5.0-linux-x86_64.tar.gz
sh ./swarm-0.5.0-linux-x86_64/swarm-package install ./swarm-0.5.0-linux-x86_64
```
...
```
Swarm 0.5.0 is healthy at http://127.0.0.1:8766/health
...
curl -fsSLO https://github.com/miopea/swarm-next/releases/download/v0.5.0/swarm-0.5.0-linux-x86_64.tar.gz
tar -xzf swarm-0.5.0-linux-x86_64.tar.gz
sh ./swarm-0.5.0-linux-x86_64/swarm-package update ./swarm-0.5.0-linux-x86_64
```
