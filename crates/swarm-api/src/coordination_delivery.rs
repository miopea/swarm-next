...
mod tests {
    ...
    fn the_run_brief_names_finished_work_and_the_move_for_each_state() {
        ...
        assert!(message.contains("swarm_reconcile_task_message"));
